    ...
    app: {
        head: {
            ...
            meta: [
                ...
                { hid: 'description', name: 'description', content: 'Pimはものづくりに関する知識と技術を共有する、島根大学公認の部活動です。' },
                ...
                { hid: 'og:description', property: 'og:description', content: 'Pimはものづくりに関する知識と技術を共有する、島根大学公認の部活動です。' },
